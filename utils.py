...
#     loss_sum = SummaryWriter()
#     #loss_sum = SummaryWriter(logdir='./logs/run')
#     tag_name = 'running_avg_loss/decay=%f' % decay
#     loss_sum.add_scalar(tag_name, running_avg_loss, step)
#     loss_sum.close()
...
def calc_running_avg_loss(loss, running_avg_loss, summary_writer, step, decay=0.99):
    ...
    # summary_writer.add_histogram(loss_sum, step)
    return running_avg_loss
